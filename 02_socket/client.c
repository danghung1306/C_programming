...
int main(int argc, char *argv[])
{
   ...
   //Tao socket
    ...
    if(inet_pton(AF_INET, argv[1], &serv_addr.sin_addr)<=0)//chuan hoa IP address form "args" -> IPv4 and copy into .sin_addr
    {
    ...
    fgets(sendbuff,sizeof(sendbuff),stdin); //Chua thong diep doc tu ban phim 
